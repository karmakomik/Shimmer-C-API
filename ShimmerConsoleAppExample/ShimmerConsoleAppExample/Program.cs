...
namespace ShimmerConsoleAppExample
{
    class Program
    {
        ...
        public void start()
        {
            ...
            int enabledSensors = ((int)ShimmerBluetooth.SensorBitmapShimmer3.SENSOR_GSR); // this is to enable Analog Accel also known as low noise accelerometer
            ...
            shimmer = new ShimmerLogAndStreamSystemSerialPort("ShimmerID1", "COM6", 1, 0, 4, enabledSensors, false, false, false, 0, 0, defaultECGReg1, defaultECGReg2, false);
        ...
        public void HandleEvent(object sender, EventArgs args)
        {
            ...
            switch (indicator)
            {
                ...
                case (int)ShimmerBluetooth.ShimmerIdentifier.MSG_IDENTIFIER_DATA_PACKET:
                    ...
                    SensorData data = objectCluster.GetData(Shimmer3Configuration.SignalNames.GSR_CONDUCTANCE, "CAL");
                    System.Console.WriteLine("GSR: " + data.Data);
